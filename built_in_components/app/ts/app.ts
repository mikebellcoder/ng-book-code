...
@Component({
  selector: 'built-in-components-app',
  template: `
  <!-- Menu Bar -->
  <div class="ui menu">
...
@NgModule({
  ...
  bootstrap: [ BuiltInComponentsApp ],
  providers: [
...
class BuiltInComponentsAppModule {}

platformBrowserDynamic().bootstrapModule(BuiltInComponentsAppModule)
